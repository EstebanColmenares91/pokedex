...
const API_URL_FETCH_POKEMON_NAME = (name) => `https://pokeapi.co/api/v2/pokemon/${name}/`;

let cantidadPokemon = 51;
...
const contenedorTipos = document.createElement('contenedor');
...
function createselectedPokemonByClick(pokemon) {
    ...
    pokemon__img.src = pokemon.sprites.front_default;
    ...
    pokemonCard.append(pokemonMainInfo, pokemon__figure,pokemon__type, pokemon__stats, spritesContainer);
